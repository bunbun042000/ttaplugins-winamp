...
!define VERSION "${BASE_VERSION} debug"
!define ALT_VER "${MAJOR_VERSION}_${MINOR_VERSION}_debug"
...
OutFile "${PLUG_ALT}_debug-${PLATFORM}.exe"
...
Section ""
  ...
  File "..\${PLATFORM}\Debug\${IN_PLUG_FILE}.dll"
  File "..\${PLATFORM}\Debug\${ENC_PLUG_FILE}.dll"
  SetOutPath "$INSTDIR\Shared"
  File "..\${PLATFORM}\Debug\${LIBTTA_DLL}.dll"
